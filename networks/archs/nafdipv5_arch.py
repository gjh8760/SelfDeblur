...
SG+SCA 대신 LeakyReLU 사용.
original UNet의 (Conv-BN-LeakyReLU) 구조와
NAFNet의 (BN-Convs-act-Conv) 구조 비교하기 위함.
...
class NAFDownBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.Conv2d(out_channels, out_channels, kernel_size=3, stride=2, padding=0, bias=True)
        )
        ...
        self.conv4 = nn.Conv2d(out_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=True)
