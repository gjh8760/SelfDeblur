...
### LeakyReLU -> SimpleGate (+ Simplified Channel Attention)
...
class NAFNet(nn.Module):
    ...
    def __init__(self, in_channel=3, out_channel=3, width=16, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[]):
        ...
        # TODO: img_channel=8이므로 self.ending 바꿔야 함
        ...
        self.skip = nn.Conv2d(in_channels=in_channel, out_channels=out_channel, kernel_size=3, padding=1, stride=1, groups=1, bias=True)
